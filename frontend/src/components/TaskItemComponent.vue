...
<template>
  <div :class="[
    'task',
    task.status === TaskStatus.COMPLETED ? '_completed' : ''
  ]">
    <div class="task__content _flex _ai-c _gap-x-12">
      ...
      <div class="task__controls _flex _ai-c _gap-x-4">
        <button v-if="(task.status === TaskStatus.ACTIVE)" type="button" @click="isNewTaskCreating = !isNewTaskCreating">
    ...
    <CollapsibleListComponent
      v-if="isSublistVisible"
      :is-visible="isVisible || isNewTaskCreating"
    >
